...
export default function GameScreen({ gameState, sessionId, turnDeadline, events, diceRoll, onIntent, onLeave }: GameScreenProps) {
    ...
    <div className="app-layout">
      ...
      <div className="app-main">
        ...
        <div className="app-board-area">
          <Board board={gameState.board} players={gameState.players} hoveredPlayerId={hoveredPlayerId} diceRoll={diceRoll} />
        </div>
